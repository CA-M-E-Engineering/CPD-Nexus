...
type AttendanceRepository interface {
	...
	List(ctx context.Context, tenantID, siteID, workerID, date string) ([]domain.Attendance, error)
...
type AttendanceService interface {
	...
	ListAttendance(ctx context.Context, tenantID, siteID, workerID, date string) ([]domain.Attendance, error)
