...
type SiteRepository interface {
	Get(ctx context.Context, userID, id string) (*domain.Site, error)
...
type SiteService interface {
	GetSite(ctx context.Context, userID, id string) (*domain.Site, error)
	ListSites(ctx context.Context, userID string) ([]domain.Site, error)
	CreateSite(ctx context.Context, s *domain.Site) error
	UpdateSite(ctx context.Context, userID, id string, s *domain.Site) error
	DeleteSite(ctx context.Context, userID, id string) error
}
